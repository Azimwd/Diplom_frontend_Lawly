...
export default function Sidebar({ refreshChats }: SidebarProps) {
			...
			<>
				{!mobileOpen && (
					<button
						...
						className="fixed top-3 left-3 z-50 h-[36px] w-[36px] bg-white dark:bg-[#1A1A1A] hover:bg-gray-100 dark:hover:bg-[#424242] border border-gray-200 dark:border-[#333] rounded-[6px] flex items-center justify-center cursor-pointer shadow-sm dark:shadow-none transition-colors"
					>
						<PanelRightOpen
							strokeWidth={1.5}
							className="h-[22px] w-[22px] text-gray-700 dark:text-white rotate-180"
						/>
					</button>
				)}
				...
				{mobileOpen && (
					<div
						className="fixed inset-0 z-40 bg-black/40 dark:bg-black/60 transition-colors"
				...
				<aside
					className={clsx(
						"fixed top-0 left-0 z-50 h-full bg-[#f9f9f9] dark:bg-[#1A1A1A] text-gray-900 dark:text-white transition-transform duration-300 w-[280px] border-r border-gray-200 dark:border-transparent",
					...
					<div className="flex flex-col justify-between w-full h-full overflow-hidden">
						<div className="flex items-center px-3 h-[60px]">
							<div className="relative h-[36px] min-w-[36px] ml-[2px] rounded-[6px] flex items-center justify-center">
								<span className="font-['Inter'] font-bold select-none mt-2 text-gray-900 dark:text-white">
									LAWLY
								</span>
							</div>
							...
							>
								<PanelRightOpen
									strokeWidth={1.5}
									className="h-[22px] w-[22px] text-gray-700 dark:text-white"
								/>
							</button>
						</div>
	...
	return (
		<aside
			className={clsx(
				"flex h-full bg-[#f9f9f9] dark:bg-[#1A1A1A] text-gray-900 dark:text-white transition-all duration-200 overflow-x-hidden border-r border-gray-200 dark:border-transparent",
