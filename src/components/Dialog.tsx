						...
						return (
							<div
								...
								className={`w-fit rounded-[10px] shrink-0 px-4 py-3 min-h-[3.2vh] break-words ${
									msg.role === "user"
										? "self-end bg-[#1E4FE0]"
										: "self-start bg-[#d8d8d8] dark:bg-[#212121] text-[#141414] dark:text-[#fff]"
								} ${
							...
							>
								...
								{msg.type === "documents_list" && msg.documents && (
									<div className="mt-3 flex flex-col gap-2 max-h-[300px] overflow-y-auto docForm">
										{msg.documents.map((doc, i) => (
											<button
												key={i}
												className="p-2 bg-[#1e1e1e] rounded-md cursor-pointer hover:bg-[#3a3a3a] text-justify mr-2"
								...
								{msg.type === "article_win_chance" &&
									...
									msg.lossRate !== undefined && (
										<div className="mt-4 p-5 bg-[#212121] border border-[#2A2A2A] rounded-[15px] w-full">
											<h3 className="text-white font-medium mb-4 text-[16px]">
											...
											<div className="flex flex-col gap-4">
												...
												<div className="w-full">
													...
													<div className="w-full bg-[#2A2A2A] rounded-full h-2.5">
														<div
															className="bg-[#8c2828] h-2.5 rounded-full transition-all duration-1000"
								...
								{msg.type === "document_generated" && (
									<div className="mt-3 p-4  bg-[#d8d8d8] dark:bg-[#212121] rounded-lg border border-[#3a3a3a] flex flex-col gap-3 w-full">
